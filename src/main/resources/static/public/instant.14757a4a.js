! function() {
    var a = document.cookie.match(/actioncontinuationhash=([^;]+)/),
        b = a && a[1];
    b && (location.hash = decodeURIComponent(b)) }(this),
function(a, b) {
    function c(a) {
        function b(a, b) {
            var c;
    ...
    function e() {
        ...
        var c = [];
        return f(document.images, function(a) { /\blazy\b/.test(a.className) && c.push(a) }), c }

    function f(a, b) {
        for (var c = a.length - 1; c >= 0; c--) b(a[c]) }
    a.stretchLazyImageHolders = function() { f(e(), d) } }(this, document),
function(a, b) { a.instant = { apply: function() {
            for (var a; a = b.shift();) a() } } }(this, [function() { window.stretchLazyImageHolders() }]),
function() {
    var a = window.document.documentElement,
        b = window.localStorage;
    if (b) {
        var c = /^\/(signup|signin)?$/.test(location.pathname);
        if ((c || "true" !== b.getItem("hideAppPromotionBar")) && (a.className += " is-AppPromotionBarVisible"), "#showWechatShareTip" === location.hash && "true" !== b.getItem("hideWechatShareTip")) try { a.className += " show-wechat-share-tip", b.setItem("hideWechatShareTip", "true") } catch (d) {} } }(this),
function(a, b, c) {
    function d(a, b) {
        return typeof a === b }
    ...
    function j(a, c, d, e) {
        var f, g, j, k, l = "modernizr",
            ...
            n = i();
        if (parseInt(d, 10))
            for (; d--;) j = h("div"), j.id = e ? e[d] : l + (d + 1), m.appendChild(j);
    ...
    function k(a) {
        return a.replace(/([A-Z])/g, function(a, b) {
            return "-" + b.toLowerCase() }).replace(/^ms-/, "-ms-") }
    ...
    function m(a) {
        return a.replace(/([a-z])-([a-z])/g, function(a, b, c) {
            return b + c.toUpperCase() }).replace(/^-/, "") }

    function n(a, b, e, f) {
        function i() { k && (delete D.style, delete D.modElem) }
        ...
        for (o = a.length, n = 0; o > n; n++)
            if (p = a[n], q = D.style[p], g(p, "-") && (p = m(p)), D.style[p] !== c) {
                if (f || d(e, "undefined")) return i(), "pfx" == b ? p : !0;
                try { D.style[p] = e } catch (s) {}
    ...
    function p(a, b, c) {
        var e;
        for (var f in a)
            if (a[f] in b) return c === !1 ? a[f] : (e = b[a[f]], d(e, "function") ? o(e, c || b) : e);
        return !1 }
    ...
    function r(a, b, d) {
        return q(a, c, c, b, d) }
    var s = [],
        t = { _version: "3.3.1", _config: { classPrefix: "", enableClasses: !0, enableJSClass: !0, usePrefixes: !0 }, _q: [], on: function(a, b) {
                var c = this;
                setTimeout(function() { b(c[a]) }, 0) }, addTest: function(a, b, c) { s.push({ name: a, fn: b, options: c }) }, addAsyncTest: function(a) { s.push({ name: null, fn: a }) } },
        u = function() {};
    ...
    u._q.push(function() { delete C.elem });
    var D = { style: C.elem.style };
    u._q.unshift(function() { delete D.style }), t.testAllProps = q;
    var E = function(b) {
        var d, e = A.length,
            f = a.CSSRule;
    ...
    var F = (t.testProp = function(a, b, d) {
        return n([a], c, b, d) }, t.testStyles = j);
    u.addTest("cssanimations", r("animationName", "a", !0)), u.addTest("csstransforms", function() {
        return -1 === navigator.userAgent.indexOf("Android 2.") && r("transform", "scale(1)", !0) }), u.addTest("csstransitions", r("transition", "all", !0)), u.addTest("flexbox", r("flexBasis", "1px", !0)), u.addTest("touchevents", function() {
        var c;
        if ("ontouchstart" in a || a.DocumentTouch && b instanceof DocumentTouch) c = !0;
            ...
            F(d, function(a) { c = 9 === a.offsetTop }) }
        return c }), e(), f(v), delete t.addTest, delete t.addAsyncTest;
    for (var G = 0; G < u._q.length; G++) u._q[G]();
    a.Modernizr = u }(window, document);
